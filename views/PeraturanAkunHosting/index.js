        ...
        >
            <section className="-mx-4 mb-4 p-4 md:mx-0">
                <div className="md:mx-auto md:max-w-[1110px] px-4">
                    ...
                    >
                        <div className="font-bold text-3xl">Peraturan Akun File Hosting</div>
                        <div className="font-normal text-base">Yuk simak peraturan akun file hosting dibawah.</div>
                    </div>
                </div>
            </section>
            ...
            <section className="-mx-4 mb-4 p-4 md:mx-0 ">
                <div className="md:mx-auto md:max-w-[1110px] px-4 flex flex-col items-center gap-5">
                    ...
                    <div className="w-[487px] flex flex-col items-start">
                        <div className="text-base font-bold">Peraturan Khusus untuk Akun Filehosting</div>
                        <ul className="list-decimal mt-3">
                            ...
                            <li className="text-base font-normal text-[#6E6C85]">
                                Jangan Download melebihi kuota yang Kami sarankan
                            </li>
                            <li className="text-base font-normal text-[#6E6C85]">
                            ...
                            <li className="text-base font-normal text-[#6E6C85]">
                                Garansi tidak berlaku jika Akun mendapat status Locked/Banned dari Admin pihak Filehosting.
                            </li>
                        </ul>
                    </div>
                </div>
