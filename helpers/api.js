...
const endpoints = {
    ...
    review: () => 'review',
    listReview: (productId) => `review/${productId}`,
};
...
export const getListReview = (payload, productId) =>
    fetchApi(endpoints.listReview(productId), payload, "get", { serviceDomainType: API_TARGET.PREMIX });